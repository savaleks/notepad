package com.savaleks.todolist;

import com.savaleks.todolist.datamodel.TodoData;
import com.savaleks.todolist.datamodel.TodoItem;
...
public class Controller {
    ...
    public void initialize() {
        ...
        wantTomorrowItems = new Predicate<TodoItem>() {
            @Override
            public boolean test(TodoItem todoItem) {
                return (todoItem.getDeadline().equals(LocalDate.now().plusDays(1L)));
            }
        };
...
//        todoListView.setItems(TodoData.getInstance().getTodoItems());
    ...
    public void handleFilterButton2() {
        ...
        if(filterToggleButton1.isSelected()) {
            //adding LocalDate.now().plusDays(1L) above #100;
